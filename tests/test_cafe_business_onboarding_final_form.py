...
from Taiji_Odoo.addons.wuchang_cafe_ai_gateway.services.cafe_business_onboarding import (  # noqa: E402
    build_cafe_business_onboarding_candidate,
    render_cafe_business_onboarding_response,
    run_cafe_business_onboarding,
)
...
class CafeBusinessOnboardingFinalFormTests(unittest.TestCase):
    def test_complete_refs_create_pass_candidate_packet(self):
        ...
        self.assertTrue(candidate["final_state_gate_ref"]["module"].endswith("final_state_gate"))
