...
Standard-library HTTP runtime. It does not start production automatically; it
...
from runtime_adapters.taiji_formal_tensor_runtime_v0_1_0_adapter import validate  # noqa: E402


RUNTIME_NAME = "taiji_formal_tensor_runtime_v0_1_0"
...
def health() -> dict[str, Any]:
    ...
    return {
        ...
        "bind_host": BIND_HOST,
        "validator": "existing_validator_or_fail_closed",
        "replay_runtime": "ok",
        "deadbox_runtime": "ok",
        "audit_runtime": "ok",
        "continuity_cache": "ok",
...
class Handler(BaseHTTPRequestHandler):
    server_version = "TaijiFormalTensorRuntime/0.1.0"
