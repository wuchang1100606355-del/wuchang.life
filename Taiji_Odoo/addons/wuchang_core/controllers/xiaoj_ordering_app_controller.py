  ...
  <script src="/wuchang_core/static/src/xiaoj_ordering/xiaoj_ordering_app.js"></script>
    ...
    def xiaoj_ordering_manifest(self, **kw):
        return {
            ...
            "merchant_invention_capability_api": "/wuchang/xiaoj/api/merchant-capabilities",
            "formal_release_status_api": "/wuchang/xiaoj/api/formal-release-status",
            "total_field_subfield_query_required_before_generation": True,
            "merchant_invention_capabilities": [
                "total_field_subfield_query",
                "candidate_authority_isolation",
                "generative_transmission",
                "sovereign_ai_membership",
                "cloud_humanoid_subscription_layer",
                "cafe_av_ordering_waiter",
                "odoo_pos_execution_gate",
                "merchant_social_governance",
                "property_community_governance",
                "dead_letter_failure_governance",
